...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 32.28
  #define DEFAULT_BED_KI 6.19
  #define DEFAULT_BED_KD 112.12
...
//#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_HEIGHT      0.01        // (mm) Z height of nozzle at tramming points
