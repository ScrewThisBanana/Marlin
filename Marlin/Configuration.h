...
#define STRING_CONFIG_H_AUTHOR "ScrewThisBanana" // Who made the changes.
...
#define PID_MAX 180 // Limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
	#define DEFAULT_Kp 8.69
	#define DEFAULT_Ki 0.41
	#define DEFAULT_Kd 46.15
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 32.28
  #define DEFAULT_bedKi 6.19
  #define DEFAULT_bedKd 112.12
...
#define EXTRUDE_MAXLENGTH 750 //@ maybe needed for filament loading
...
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 10, 75 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -43, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE_MOVE    150   // (mm/s) Feedrate for XY Moves without extrusion for the G26 Mesh Validation Tool
...
//#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT      0.01   // (mm) Z height of nozzle at leveling points
...
//
#define TOUCH_SCREEN // Disable for lvgl ui
